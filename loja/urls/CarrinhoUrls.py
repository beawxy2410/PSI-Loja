...
from loja.views.CarrinhoView import create_carrinhoitem_view, list_carrinho_view, confirmar_carrinho_view, remover_item_view, atualizar_carrinhoitem_view
urlpatterns = [
    ...
    path('atualizar/<int:item_id>/', atualizar_carrinhoitem_view, name='update_carrinhoitem')
]